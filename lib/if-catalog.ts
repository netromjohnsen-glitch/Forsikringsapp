...
export const ifFacts: Record<string, CatalogFact[]> = {
  ...
  ifSuper: facts("ifSuper", [
    ...
    ["nyverdi.utloser", "Totalskadegaranti – utløsende kostnadsgrense", "Reparasjonsomkostningene må overstige bilens gjenanskaffelsesverdi", "4.11.1", 11],
    ...
    ["bilnokkel", "Bilnøkkel/fjernkontroll", "Ny nøkkel, programmering og omkoding ved plutselig ytre skade, tap eller tyveri", "4.11.2", 12],
    ["ladekabel", "Ladekabel", "Tilfeldig, plutselig ytre hendelse eller tyveri/hærverk på ladekabel", "4.11.2", 12],
