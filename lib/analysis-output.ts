...
- For hvert Bil-objekt: returner eksplisitt dokumentert aldersgrense for totalskadegaranti/nyverdierstatning/nybilgaranti som nyverdi.alder og kilometergrense som nyverdi.km i separate importantTerms, også når grensene står på ulike linjer eller under et produktnivå. Behold dokumentets verdier og knytt dem bare til riktig objekt og produktnivå. Ikke la disse grensene bare stå i coverageSummary eller en sammensatt grense; kontroller begge feltene før du returnerer. Ikke opprett manglende grenser og ikke bruk maskinskade, kjørelengde eller kilometerstand som totalskadegrense.
