...
export const gjensidigeInnboFacts: Record<string, CatalogFact[]> = {
  ...
  gjInnboPlus: facts([
    ...
    ["tyveri.fellesbod.grense", "Tyveri fra bod i felles kjeller eller loft – grense", "Innenfor ubegrenset innbosum og dokumenterte særgrenser", "gjInnboPlus", "Forsikringsbevis – Hvilke skader", 4, true],
