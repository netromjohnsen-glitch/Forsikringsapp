...
export const gjensidigeFacts: Record<string, CatalogFact[]> = {
  ...
  gjKasko: facts("gjKasko", [
    ...
    ["nyverdi.utloser", "Totalskadegaranti – utløsende grense", "Bilen tapt eller reparasjonsutgiftene overstiger markedsverdi for tilsvarende bil", "Erstatningsregler – Totalskadegaranti", 15],
