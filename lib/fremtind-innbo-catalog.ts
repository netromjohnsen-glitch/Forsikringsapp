...
export const fremtindInnboFacts: Record<string, CatalogFact[]> = {
  ...
  fremtindInnboTopp: facts([
    ...
    ["skadedyr.dekning", "Bekjempelse av skadedyr", "Bekjempelse av veggedyr og kakerlakker samt inntil tre befaringer for skjeggkre; skade på innbo forårsaket av mus og rotter omfattes med angitte unntak", "fremtindInnboTopp", "4.7 og 4.9", 4],
